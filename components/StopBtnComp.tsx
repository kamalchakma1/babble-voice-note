...
export default function StopBtnComp() {
  ...
  return isRecordingStopAto ? (
    <button onClick={doneFun} className="bg-white text-slate-400 relative text-2xl font-medium shadow-md w-[10rem] h-[10rem] rounded-full flex items-center justify-center">
      Done
    ...
    <button
      ...
      className="bg-white text-slate-400 relative hover:text-[#FFB98A] text-2xl font-medium shadow-md w-[10rem] h-[10rem] rounded-full flex items-center justify-center"
    >
      Stop
      <div className="w-[10rem] absolute h-[10rem] hover:w-[8rem] hover:transition-all duration-150 hover:h-[8rem] border-[0.3px] hover:border-[#FFB98A] border-transparent rounded-full"></div>
    </button>
